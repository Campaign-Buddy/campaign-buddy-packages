import{j as o}from"./jsx-runtime-PJfywvQB.js";import{r as a,R as le}from"./index-tnPESBdE.js";import{u as ie}from"./useBooleanState-BvRGCuoP.js";import{i as de}from"./index-C4WGByT4.js";import{H as p,C as q,W as P,Z as nt}from"./styled-components.browser.esm-CuL3HyEV.js";import{_ as pe,l as ue,n as me,o as ot,I as G,p as st,B as fe,q as rt,r as at,s as _,D as ye,t as ge,v as it,w as ct,x as lt,y as X,z as J,O as he,G as dt,H as pt,J as ut,a as mt,S as Te,P as te,m as ft,T as yt,b as xe,c as gt,d as ht,E as Tt,A as xt,e as It,N as bt,M as vt,f as Ct,C as wt,g as kt,K as Rt,F as Ie,h as be,u as ve,i as Ot,j as $t,k as jt}from"./fuse.esm-BSXXkDLL.js";import{u as Nt}from"./index-D_0btrl3.js";import{u as St,a as Ce}from"./useCombinedRefs-Dfiq_Z7b.js";import{t as qt}from"./index-B9gZL0fq.js";import{r as Dt}from"./index-BJt650PE.js";const y=qt.parchment;var Mt=function(e){pe(t,e);function t(){var n=e!==null&&e.apply(this,arguments)||this;return n.handleActionClick=function(s){var r,i;(i=(r=n.props.action)===null||r===void 0?void 0:r.onClick)===null||i===void 0||i.call(r,s),n.triggerDismiss(!1)},n.handleCloseClick=function(){return n.triggerDismiss(!1)},n.startTimeout=function(){n.clearTimeouts(),n.props.timeout>0&&n.setTimeout(function(){return n.triggerDismiss(!0)},n.props.timeout)},n}return t.prototype.render=function(){var n=this.props,s=n.className,r=n.icon,i=n.intent,c=n.message;return a.createElement("div",{className:ue(me,ot(i),s),onBlur:this.startTimeout,onFocus:this.clearTimeouts,onMouseEnter:this.clearTimeouts,onMouseLeave:this.startTimeout,tabIndex:0},a.createElement(G,{icon:r}),a.createElement("span",{className:st},c),a.createElement(fe,{minimal:!0},this.maybeRenderActionButton(),a.createElement(rt,{"aria-label":"Close",icon:"cross",onClick:this.handleCloseClick})))},t.prototype.componentDidMount=function(){this.startTimeout()},t.prototype.componentDidUpdate=function(n){n.timeout!==this.props.timeout&&(this.props.timeout>0?this.startTimeout():this.clearTimeouts())},t.prototype.componentWillUnmount=function(){this.clearTimeouts()},t.prototype.maybeRenderActionButton=function(){var n=this.props.action;if(n!=null)return a.createElement(at,_({},n,{intent:void 0,onClick:this.handleActionClick}))},t.prototype.triggerDismiss=function(n){var s,r;this.clearTimeouts(),(r=(s=this.props).onDismiss)===null||r===void 0||r.call(s,n)},t.defaultProps={className:"",message:"",timeout:5e3},t.displayName="".concat(ye,".Toast"),t}(ge),Pt=function(e){pe(t,e);function t(){var n=e!==null&&e.apply(this,arguments)||this;return n.state={toasts:[]},n.toastId=0,n.renderToast=function(s){return a.createElement(Mt,_({},s,{onDismiss:n.getDismissHandler(s)}))},n.getDismissHandler=function(s){return function(r){n.dismiss(s.key,r)}},n.handleClose=function(s){s.which===ut&&n.clear()},n}return t.create=function(n,s){s===void 0&&(s=document.body),n!=null&&n.usePortal!=null&&!it("production")&&console.warn(ct);var r=document.createElement("div");s.appendChild(r);var i=Dt.render(a.createElement(t,_({},n,{usePortal:!1})),r);if(i==null)throw new Error(lt);return i},t.prototype.show=function(n,s){this.props.maxToasts&&this.dismissIfAtLimit();var r=this.createToastOptions(n,s);return s===void 0||this.isNewToastKey(s)?this.setState(function(i){return{toasts:X([r],i.toasts,!0)}}):this.setState(function(i){return{toasts:i.toasts.map(function(c){return c.key===s?r:c})}}),r.key},t.prototype.dismiss=function(n,s){s===void 0&&(s=!1),this.setState(function(r){var i=r.toasts;return{toasts:i.filter(function(c){var l,d=c.key===n;return d&&((l=c.onDismiss)===null||l===void 0||l.call(c,s)),!d})}})},t.prototype.clear=function(){this.state.toasts.forEach(function(n){var s;return(s=n.onDismiss)===null||s===void 0?void 0:s.call(n,!1)}),this.setState({toasts:[]})},t.prototype.getToasts=function(){return this.state.toasts},t.prototype.render=function(){var n=ue(J,this.getPositionClasses(),this.props.className);return a.createElement(he,{autoFocus:this.props.autoFocus,canEscapeKeyClose:this.props.canEscapeKeyClear,canOutsideClickClose:!1,className:n,enforceFocus:!1,hasBackdrop:!1,isOpen:this.state.toasts.length>0||this.props.children!=null,onClose:this.handleClose,shouldReturnFocusOnClose:!1,transitionDuration:350,transitionName:me,usePortal:this.props.usePortal},this.state.toasts.map(this.renderToast,this),this.props.children)},t.prototype.validateProps=function(n){var s=n.maxToasts;if(s!==void 0&&s<1)throw new Error(dt)},t.prototype.isNewToastKey=function(n){return this.state.toasts.every(function(s){return s.key!==n})},t.prototype.dismissIfAtLimit=function(){this.state.toasts.length===this.props.maxToasts&&this.dismiss(this.state.toasts[this.state.toasts.length-1].key)},t.prototype.createToastOptions=function(n,s){return s===void 0&&(s="toast-".concat(this.toastId++)),_(_({},n),{key:s})},t.prototype.getPositionClasses=function(){var n=this.props.position.split("-");return X(X([],n.map(function(s){return"".concat(J,"-").concat(s.toLowerCase())}),!0),["".concat(J,"-").concat(this.props.usePortal?"in-portal":"inline")],!1)},t.displayName="".concat(ye,".Toaster"),t.defaultProps={autoFocus:!1,canEscapeKeyClear:!0,position:pt.TOP,usePortal:!0},t}(ge);const we=p(mt)`
	label.bp4-label {
...
`;Me.defaultProps={theme:y};const Pe=({value:e,onChange:t,label:n,id:s,rightElement:r,...i})=>{const c=a.useCallback(m=>{t(m.target.value)},[t]),l=D(),d=s??l;return o.jsx(N,{label:n,labelFor:d,children:o.jsx(Me,{value:e,onChange:c,id:d,rightElement:r,...i})})};Pe.__docgenInfo={description:"",methods:[],displayName:"Input",props:{value:{required:!0,tsType:{name:"T"},description:""},onChange:{required:!0,tsType:{name:"signature",type:"function",raw:"(value: T) => void",signature:{arguments:[{type:{name:"T"},name:"value"}],return:{name:"void"}}},description:""},label:{required:!1,tsType:{name:"ReactReactNode",raw:"React.ReactNode"},description:""},placeholder:{required:!1,tsType:{name:"string"},description:""},rightElement:{required:!1,tsType:{name:"JSX.Element"},description:""}}};const Ee=p(gt)`
	...
	resize: vertical;
	min-height: 75px;
`;Ee.defaultProps={theme:y};const _e=({value:e,onChange:t,label:n,id:s,...r})=>{const i=a.useCallback(d=>t(d.target.value),[t]),c=D(),l=s??c;return o.jsx(N,{label:n,labelFor:l,children:o.jsx(Ee,{value:e,onChange:i,fill:!0,id:l,...r})})};_e.__docgenInfo={description:"",methods:[],displayName:"TextArea",props:{value:{required:!0,tsType:{name:"T"},description:""},onChange:{required:!0,tsType:{name:"signature",type:"function",raw:"(value: T) => void",signature:{arguments:[{type:{name:"T"},name:"value"}],return:{name:"void"}}},description:""},label:{required:!1,tsType:{name:"ReactReactNode",raw:"React.ReactNode"},description:""}}};const Ae=p(xe)`
	input {
		${L}
	}
...
`;Ae.defaultProps={theme:y};const Fe=({value:e,label:t,onChange:n,onBlur:s,onKeyDown:r,id:i,...c})=>{const[l,d]=a.useState(`${e??0}`),m=D(),g=i??m,b=nt();a.useEffect(()=>{d(`${e??0}`)},[e]);const h=a.useCallback(()=>{try{const T=l.replace(/(\d+)?d(\d+)/g,(v,f,j)=>{const E=parseInt(f??"1"),R=parseInt(j);let k=0;for(let S=0;S<E;S++)k+=Math.floor(Math.random()*R)+1;return`${k}`}),u=parseFloat(ht.eval(T));if(isNaN(u))return u;n(u)}catch{}},[l,n]),C=a.useCallback(T=>{const u=parseFloat(l);isNaN(u)?(d(`${T}`),n(T)):(d(`${u+T}`),n(u+T))},[n,l]),x=a.useCallback(()=>C(1),[C]),I=a.useCallback(()=>C(-1),[C]),w=a.useCallback(T=>{T.keyCode===Tt?h():T.keyCode===xt?I():T.keyCode===It&&x(),r==null||r(T)},[h,r,I,x]),O=a.useCallback(T=>{h(),s==null||s(T)},[h,s]),$=a.useCallback(T=>{d(T.target.value);const u=parseFloat(T.target.value);isNaN(u)||n(u)},[n]);return o.jsx(N,{label:t,labelFor:g,children:o.jsx(Ae,{value:l,onChange:$,onKeyDown:w,onBlur:O,fill:!0,id:g,className:bt,rightElement:o.jsxs(fe,{vertical:!0,children:[o.jsx(M,{variant:b.input.numeric.incrementButtons,onClick:x,icon:"chevron-up"}),o.jsx(M,{variant:b.input.numeric.incrementButtons,onClick:I,icon:"chevron-down"})]}),...c})})};Fe.__docgenInfo={description:"",methods:[],displayName:"NumberInput",props:{value:{required:!0,tsType:{name:"T"},description:""},onChange:{required:!0,tsType:{name:"signature",type:"function",raw:"(value: T) => void",signature:{arguments:[{type:{name:"T"},name:"value"}],return:{name:"void"}}},description:""},label:{required:!1,tsType:{name:"ReactReactNode",raw:"React.ReactNode"},description:""}}};const Yt=q`
...
`;ze.defaultProps={theme:y};const un={popoverClassName:"bp-overrides-context-menu-popover",hasBackdrop:!1};function He({item:e}){var t;return o.jsx(U,{icon:e.icon,text:e.displayText,onClick:e.onClick,popoverProps:un,tagName:"button",shouldDismissPopover:e.shouldCloseMenuOnClick,children:(t=e==null?void 0:e.subItems)==null?void 0:t.map(n=>o.jsx(He,{item:n},n.displayText))})}const oe=le.forwardRef(({menuItems:e,children:t,as:n,...s},r)=>o.jsxs(o.Fragment,{children:[o.jsx(ze,{}),o.jsx(wt,{tagName:n,...s,ref:r,content:o.jsx(B,{children:e.map((i,c)=>o.jsx(He,{item:i},i.displayText??c))}),children:t})]}));oe.displayName="ContextMenu";oe.__docgenInfo={description:"",methods:[],displayName:"ContextMenu",props:{menuItems:{required:!0,tsType:{name:"Array",elements:[{name:"MenuItemType"}],raw:"MenuItemType[]"},description:""},as:{required:!1,tsType:{name:"JSX.IntrinsicElements"},description:""}},composes:["Omit"]};const z="CB_CORE_UI_LIST_ITEM",Ve=q`
	list-style: none;
	padding: 0;
	margin: 0;
`,mn=p.div`
...
`;et.defaultProps={theme:y};const zn=({value:e,onChange:t,label:n,...s})=>{const r=a.useCallback(i=>t(i.target.checked),[t]);return o.jsx(et,{checked:e,onChange:r,label:n,...s})};zn.__docgenInfo={description:"",methods:[],displayName:"Switch",props:{label:{required:!1,tsType:{name:"string"},description:""}},composes:["Omit"]};const Hn=p(jt)`
	background-color: ${({theme:e})=>e.legacyCoreUi.colors.primary};
